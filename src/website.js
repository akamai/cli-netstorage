...
class WebSite {
        ...
        return new Promise((resolve, reject) => {
            ...
            rules.rules.behaviors.map(behavior => {
                ...
                if (behavior.name == "cpCode") {
                    behavior.options.cpcode = cpcode;
                }
    ...
    create(hostnames = ['www.example.com'], cpcode = null, name = null, contract = null, newRules = null) {

        //TODO: set name based on hostnames[0]
        //TODO: verify that the name is [A-Za-z0-9_-.] and replace all other characters with '_'
        //TODO: check if hostnames is a literal and promote to an array
        //TODO: use the passed in contract
        ...
        //TODO move this model logic out of the controller interface
        return this._getGroupList()
            .then(data => {
            ...
            .then(data => {
                cpcode = 548751;
                if (cpcode) {
                    return Promise.resolve({"id": cpcode});
                } else {
    ...
    createFromFile(hostnames = ['www.example.com'], srcFile, name = null, contract = null) {
        //TODO: do all the things
        //TOOD: read srcfile and pass up to create()

    }

    createFromExisting(srcProperty, srcVersion = LATEST_VERSION.LATEST, copyHostnames = false, hostnames = ['www.example.com'], name = null, contract = null) {
        //TODO: set name based on hostnames[0]
        //TODO: verify that the name is [A-Za-z0-9_-.] and replace all other characters with '_'
        //TODO: check if hostnames is a literal and promote to an array
        //TODO: use the passed in contract
